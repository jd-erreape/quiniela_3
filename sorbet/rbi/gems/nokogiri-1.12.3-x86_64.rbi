...
class Nokogiri::XML::SAX::Parser::Attribute < Anonymous_Struct_3
end
...
class Nokogiri::XML::Notation < Anonymous_Struct_4
end
...
class Nokogiri::HTML4::EntityDescription < Anonymous_Struct_5
end
